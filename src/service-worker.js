const APP_PREFIX = 'schedule'; // Identifier for this app (this needs to be consistent across every cache update)
...
const URLS = [
	...
	'/schedule/', // If you have separate JS/CSS files,
	'/schedule/index.html' // add path to those files here
];
